...
public abstract class CA_MethodHook extends XCallback {
    /**
     * Creates a new callback with default priority.
     */
    @SuppressWarnings("deprecation")
    public CA_MethodHook() {
        super();
    }
     ...
     */
    public CA_MethodHook(int priority) {
        super(priority);
    }
     ...
     */
    public class Unhook implements IXUnhook<CA_MethodHook> {
        ...
        @Override
        public CA_MethodHook getCallback() {
            return CA_MethodHook.this;
        }

        @SuppressWarnings("deprecation")
        @Override
        public void unhook() {
            CalvinBridge.unhookMethod(hookMethod, CA_MethodHook.this);
        }
